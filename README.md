...
**Leaderboard** is a project to build a website that displays scores submitted by different players. It also allows you to submit your score. All data is preserved, thanks to an external Leaderboard API service.
